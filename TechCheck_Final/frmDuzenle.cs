...
namespace TechCheck_Final
{
    public partial class frmDuzenle : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=mnjrosan;Integrated Security=True;Encrypt=False;");
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                komut.ExecuteNonQuery();//Veri döndürmeyen komutlar için kullanılır, güncelleme işlemi olduğu için uygundur.
                baglanti.Close();
